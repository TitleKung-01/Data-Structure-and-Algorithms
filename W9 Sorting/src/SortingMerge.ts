...
function mergeSort(arr: number[]): number[] { // สร้าง function mergeSort รับค่า arr เป็น array ของตัวเลข
...
function merge(left: number[], right: number[]): number[] { // สร้าง function merge รับค่า left เป็น array ของตัวเลข และ right เป็น array ของตัวเลข
